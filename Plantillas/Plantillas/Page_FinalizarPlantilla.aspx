...
<asp:Content ID="CFinalizarPlantilla" ContentPlaceHolderID="CPHPlantillas" runat="server">
    ...
    <script type="text/javascript">
        function openModal() {
            var confirmar = confirm("Crear� un nuevo registro. Seguro que desea continuar?");
...
//            });
    ...
    <p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0;"></span>Se crear� un registro. Seguro que desea continuar?</p>
</div>--%>
</asp:Content>

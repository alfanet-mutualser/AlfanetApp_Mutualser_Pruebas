...
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w1"></asp:HiddenField> 
	...
	<asp:Panel style="LEFT: 213px; TOP: 132px" id="PnlCargarDocVen" runat="server" Width="380px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w3" ScrollBars="Both"><DIV>
...
</asp:TreeView> </DIV></asp:Panel> <ajaxToolkit:AutoCompleteExtender id="ACECargarDocEnv" runat="server" Enabled="True" TargetControlID="TxtCargarDocVen" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDependenciaByText" MinimumPrefixLength="1" EnableCaching="true" CompletionInterval="100" UseContextKey="true" CompletionSetCount="20" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" __designer:wfdid="w7"></ajaxToolkit:AutoCompleteExtender> <ajaxToolkit:PopupControlExtender id="PCECargarDocEnv" runat="server" TargetControlID="TxtCargarDocVen" PopupControlID="PnlCargarDocVen" __designer:wfdid="w8" Position="Center" OffsetY="25" OffsetX="-380"></ajaxToolkit:PopupControlExtender> 
    <ajaxToolkit:AutoCompleteExtender id="ACECargarDocEnvSerie" runat="server" TargetControlID="TxtCargarDocVenSerie" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetSubSerieByText" MinimumPrefixLength="1" EnableCaching="true" CompletionInterval="100" UseContextKey="true" CompletionSetCount="20"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" __designer:wfdid="w7"></ajaxToolkit:AutoCompleteExtender> <ajaxToolkit:PopupControlExtender id="PCECargarDocEnvSerie" runat="server" TargetControlID="TxtCargarDocVenSerie" PopupControlID="PnlCargarDocVen" __designer:wfdid="w8" Position="Center" OffsetY="25" OffsetX="-380"></ajaxToolkit:PopupControlExtender>
</DataItemTemplate>
...
<ajaxToolkit:AutoCompleteExtender id="AutoCompleteExtender1" runat="server" TargetControlID="TxtAccionDocExtVen" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetWFAccionTextByText" MinimumPrefixLength="1" EnableCaching="true" CompletionInterval="100" UseContextKey="true" CompletionSetCount="20" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" __designer:wfdid="w20">
...
<dxwgv:GridViewDataTextColumn Width="149px" Caption="Acci&#243;n:" VisibleIndex="11"><DataItemTemplate>
    <asp:TextBox ID="TxtAccionDocExtVen" runat="server" CssClass="TextBoxStyleGrid" Font-Size="X-Small" Width="145px" Enabled="False"></asp:TextBox>
                                        <ajaxToolkit:AutoCompleteExtender
                                                ID="AutoCompleteExtender5" runat="server" MinimumPrefixLength="1" EnableCaching="true" CompletionInterval="100" UseContextKey="true" CompletionSetCount="20"

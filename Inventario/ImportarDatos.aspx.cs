...
public partial class ImportarDatos : System.Web.UI.Page
{
    ...
    {
        // string cadena = @"Data Source=ALFANET2;Initial Catalog=Alfanet_Pruebas;password=Mutual2016$;User Id=sa; MultipleActiveResultSets=true; Connect Timeout=720";
		string cadena = @"Data Source=192.168.211.197;Initial Catalog=Alfanet_Pruebas;password=Bogota2020$$;User Id=archivar; MultipleActiveResultSets=true; Connect Timeout=720";
    ...
    private void GuardarArchivo(HttpPostedFile file)
    {
        ...
        // conn.ConnectionString = (@"Data Source=ALFANET2;Initial Catalog=Alfanet_Pruebas;password=Mutual2016$;User Id=sa; MultipleActiveResultSets=true; Connect Timeout=720");
		conn.ConnectionString = (@"Data Source=192.168.211.197;Initial Catalog=Alfanet_Pruebas;password=Bogota2020$$;User Id=archivar; MultipleActiveResultSets=true; Connect Timeout=720");		
        {

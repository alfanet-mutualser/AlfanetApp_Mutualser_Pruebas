...
<script runat="server" language="C#">
    ...
    {        
       ...
       if (Request.ContentType.IndexOf("multipart/form-data") < 0)
            ...
            // Response.Write( "Resultados Finales: " + "\r\n" + Request.Files.Count.ToString() +  " Archivo(s):" + "\r\n");
				Response.Write("Resultados Finales: " + "<br>" + Request.Files.Count.ToString() + " Archivo(s):" + "<br>");
...

            {
...

                {
                    ...
                    String strPath = Path.GetFileName(objFile.FileName);
